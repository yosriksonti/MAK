 ...
 */
final class Version20220919124815 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE depence (id INT AUTO_INCREMENT NOT NULL, vehicule_id INT NOT NULL, prix DOUBLE PRECISION NOT NULL, designation VARCHAR(255) NOT NULL, INDEX IDX_7EC785064A4A3511 (vehicule_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE feedback (id INT AUTO_INCREMENT NOT NULL, client_id INT NOT NULL, body LONGTEXT NOT NULL, created_on DATETIME NOT NULL, rating INT NOT NULL, INDEX IDX_D229445819EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE location (id INT AUTO_INCREMENT NOT NULL, client_id INT NOT NULL, vehicule_id INT NOT NULL, num VARCHAR(255) NOT NULL, ip VARCHAR(255) NOT NULL, date_res DATE NOT NULL, date_loc DATE NOT NULL, date_retour DATE NOT NULL, montant DOUBLE PRECISION NOT NULL, avance DOUBLE PRECISION NOT NULL, type VARCHAR(255) NOT NULL, etat VARCHAR(255) NOT NULL, status VARCHAR(255) NOT NULL, is_baby_seat TINYINT(1) NOT NULL, is_personal_driver TINYINT(1) NOT NULL, is_second_driver TINYINT(1) NOT NULL, is_stw TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_5E9E89CBDC43AF6E (num), INDEX IDX_5E9E89CB19EB6921 (client_id), INDEX IDX_5E9E89CB4A4A3511 (vehicule_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');

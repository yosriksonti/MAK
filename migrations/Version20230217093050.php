 ...
 */
final class Version20230217093050 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE agence (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, addresse VARCHAR(255) NOT NULL, frais DOUBLE PRECISION NOT NULL, maps VARCHAR(255) NOT NULL, maps_frame VARCHAR(510) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE location (id INT AUTO_INCREMENT NOT NULL, client_id INT NOT NULL, vehicule_id INT NOT NULL, agence_depart_id INT NOT NULL, agence_arrive_id INT NOT NULL, num VARCHAR(255) NOT NULL, ip VARCHAR(255) NOT NULL, date_res DATETIME NOT NULL, date_loc DATETIME NOT NULL, date_retour DATE NOT NULL, montant DOUBLE PRECISION NOT NULL, avance DOUBLE PRECISION NOT NULL, type VARCHAR(255) NOT NULL, etat VARCHAR(255) NOT NULL, status VARCHAR(255) NOT NULL, is_baby_seat TINYINT(1) NOT NULL, is_reservoire TINYINT(1) NOT NULL, is_personal_driver TINYINT(1) NOT NULL, is_second_driver TINYINT(1) NOT NULL, is_stw TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_5E9E89CBDC43AF6E (num), INDEX IDX_5E9E89CB19EB6921 (client_id), INDEX IDX_5E9E89CB4A4A3511 (vehicule_id), INDEX IDX_5E9E89CB209D99B2 (agence_depart_id), INDEX IDX_5E9E89CB7A9DE1B1 (agence_arrive_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');

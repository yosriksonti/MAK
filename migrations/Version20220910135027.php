 ...
 */
final class Version20220910135027 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE feedback (id INT AUTO_INCREMENT NOT NULL, vehicule_id INT NOT NULL, client_id INT NOT NULL, body LONGTEXT NOT NULL, created_on DATETIME NOT NULL, rating INT NOT NULL, INDEX IDX_D22944584A4A3511 (vehicule_id), INDEX IDX_D229445819EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
